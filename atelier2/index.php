...
if (isset($_COOKIE['authToken']) && $_COOKIE['authToken'] === $mdpgen) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username === 'admin' && $password === 'secret') {
        $mdpgen === bin2hex(random_bytes(16))
        setcookie('authToken', mdpgen, time() + 60, '/', '', false, true); // Le Cookie est initialisé et valable pendant 1 heure (3600 secondes) 
